...
| containerStyle | Styling override for the overall container view |
...
| maxTags | Max number of tags that can be added |
| onHeightChange | Callback that gets passed the new component height when it changes |
| noAutoScroll | Disable automatic scrolling to bottom if specified |
