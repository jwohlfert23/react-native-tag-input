    ...
    return <TouchableWithoutFeedback onPress={() => this.refs.emailInput.focus()} onLayout={this.measureWrapper.bind(this)} style={{
      ...
      <View style={styles.wrapper} ref="wrapper" onLayout={this.measureWrapper.bind(this)}>
        ...
        <View style={{
          ...
          ]} autoCapitalize="none" autoCorrect={false} placeholder={this.props.placeholder} keyboardType={this.props.keyboardType || "email-address"} underlineColorAndroid="rgba(0,0,0,0)" onChange={this.onChange.bind(this)} onSubmitEditing={this.parseEmails}/>
        </View>
      </View>
    </TouchableWithoutFeedback>
  }
